...
def main():
    ...
    with ThreadPoolExecutor() as executor:
        futures.append(executor.submit(fetch_mit, 10))
        futures.append(executor.submit(fetch_iea, 10))
        futures.append(executor.submit(fetch_en, 10))
        futures.append(executor.submit(fetch_rn, 10))
        futures.append(executor.submit(fetch_mi, 10))
